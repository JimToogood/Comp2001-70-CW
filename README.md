...
*To use the prebuilt docker image provided (built using --platform linux/amd64, tested on MacOS, but should still run on Windows machines):*
3) Download prebuilt image from here (too big for GitHub): https://drive.google.com/file/d/1c10HCoMGZE6to0KPeoZz26XguX36sd3M/view?usp=sharing
...
*Or to build the docker image yourself:*
